...
<head>
    ...
    <!-- Custom CSS -->
    <link href="css/taskly.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index2.html">Taskly</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="index2.html" data-toggle="tooltip" data-placement="right" title="Dashboard"><i class="fa fa-fw fa-dashboard fa-3x"></i></a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!-- Panel -->
                    <div class="col-md-7 col-md-offset-2 panel panel-default" style="background-color: #222 !important; border: none !important;">
                      <div class="panel-body panel-task-view">
                        <h2 style="color: #fff !important;">Tasks</span></h2>
                        <div class="spacer"></div>
                        <div class="col-md-6">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a type="button" class="btn btn-primary" href="calendar.html">Add Event</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="course-modal" tabindex="-1" role="dialog" aria-labelledby="course-modal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            <a type="button" class="btn btn-primary" href="assignments.html">Add Course</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="assignment-modal" tabindex="-1" role="dialog" aria-labelledby="assignment-modal" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            <a type="button" class="btn btn-primary" href="assignments.html">Add Assignment</a>
          </div>
        </div>
      </div>
    </div>
    ...
    // Function to enforce minimum window width
    function enforceMinWidth() {
        if (window.innerWidth < minWidth) {
            // Resize the window to the minimum width
            window.resizeTo(minWidth, window.innerHeight);
        }
    }

    // Function to check device width and block access if less than or equal to 768px
    function checkDeviceWidth() {
        if (window.innerWidth < minWidth) {
            ...
            alert("Sorry, Taskly is not available on mobile.");
            window.location.href = "login.html"; // Redirect to login.html after alert
            return false; // Block further execution
        }
        return true; // Allow execution
    }

    // Function to alert the mobile message
    function alertMobileMessage() {
        if (window.innerWidth < minWidth) {
            alert("Sorry, Taskly is not available on mobile.");
            window.location.href = "login.html"; // Redirect to login.html after alert
        }
    ...
    // Validate login credentials and enforce device width check
    function validateLogin() {
        ...
        // Simulate credential validation (replace this with actual validation logic)
        const username = document.getElementById("username").value;
        const password = document.getElementById("password").value;

        // Example validation (replace with your actual logic)
        if (username === "user" && password === "pass") {
            // Redirect to index2.html if credentials are correct
            window.location.href = "index2.html";
            return false; // Prevent form submission (since we're redirecting manually)
        } else {
            alert("Invalid username or password.");
            window.location.href = "login.html"; // Redirect to login.html if validation fails
            return false; // Prevent form submission
        }
    }

    // Enforce minimum width and device width check when the page loads
    enforceMinWidth();
    checkDeviceWidth();

    // Enforce minimum width on window resize
    window.addEventListener("resize", () => {
        enforceMinWidth();
        alertMobileMessage(); // Alert the mobile message on resize
    });

    // Continuously monitor and enforce minimum width
    setInterval(enforceMinWidth, 100); // Check every 100ms
</script>
